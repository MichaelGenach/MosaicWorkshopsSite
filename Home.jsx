...
export default function Home(props) {
    ...
    const photos = [photo117, photo119,
            ...
            <div className='container'>
                ...
                <div className='frontTitleDiv' >
                    ...
                    <FadeIn>
                        ...
                        <h1 id='title' 
                        >Genach Workshops</h1>
                        <h1 id='title2'>סדנאות פסיפסים קדרות והפקות אירועי גיבוש בנמל קיסריה</h1>
                        <p id='titleh2'>
...
<div id='lepirteiVeLasadnaDiv'>
                        ...
                        <Link to={'/bookingWidget'}><button id='lasadna'> להזמנת סדנא </button></Link>
