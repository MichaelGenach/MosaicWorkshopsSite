  ...
  return (
    ...
    <div id='mainDivPrivate' >
      ...
      <FadeIn>
       ...
       <div id='uuu'>
        <h1 style={{ color: 'white' }} id='titlePrivate' > סדנאות פסיפס בוטיק </h1>
        <p style={{ color: 'white' }} id='subTitlePrivate' >צרו פסיפסים מרהיבים יחד עם יקיריכם <br /> בליווי מומחי פסיפס וקחו את יצירותיכם הביתה</p>
        </div>
          ...
          <div id='infoDivPrivate'>
              ...
              <h2 className='h2'> ?מה כלול במחיר
              </h2>
              <div id='bottomTextDiv'>
              <p  id='bottomText'>   אנחנו מעבירים את הסדנאות המיוחדות שלנו בגלריית פסיפסים עתיקה מול הים
                בה אנחנו מוכרים ומייצרים פסיפסים בשיטה עתיקה ובסטנדרט גבוה, 
                כמו כן הסדנא כוללת ליווי צמוד  של אנשי מקצוע  מנוסים, עמדת קפה עם כיבוד קל ומוזיקה לבחירה</p>
